...
import LinkDropper from "./LinkDropper";
...
const MenuDropper = ({ data, label }) => {
  ...
  return (
    <div className="menuDropperContainer">
      <div className="menuDropperHeading regular-14 w-400">
        {label}
      </div>
      {data?.map((e, index) => {
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  className="menuDropperIcon"
                />
                <span className="menuDropperSpan">{type?.label}</span>
              </motion.div>
            </RenderDiv>
            {type?.label === linkType ? (
              <LinkDropper
